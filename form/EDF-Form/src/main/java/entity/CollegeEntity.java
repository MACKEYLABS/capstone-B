...
public class CollegeEntity {
    ...
    @Basic
    @Column(name = "college_tuition_cost")
    ...
    public boolean equals(Object o) {
        ...
        if (collegeTuitionCost != null ? !collegeTuitionCost.equals(that.collegeTuitionCost) : that.collegeTuitionCost != null)
            return false;
        if (collegeFundsRequested != null ? !collegeFundsRequested.equals(that.collegeFundsRequested) : that.collegeFundsRequested != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (collegeTuitionCost != null ? collegeTuitionCost.hashCode() : 0);
        result = 31 * result + (collegeFundsRequested != null ? collegeFundsRequested.hashCode() : 0);
        return result;
    }
}
